...
//  NHMatch
//
//  Created by Catherine Sweeney on 10/09/2012.
...
case 4:
  {
      matchCards[0]=targetName;
      matchCards[1]=targetName;
      matchCards[2]=dist1Name;
      matchCards[3]=dist1Name;
      break;
case 6:
       matchCards[0]=targetName;
       matchCards[1]=targetName;
       matchCards[2]=dist1Name;
       matchCards[3]=dist1Name;
       matchCards[4]=dist2Name;
       matchCards[5]=dist2Name;
       break;
case 9:
        matchCards[0]=targetName;
        matchCards[1]=targetName;
        matchCards[2]=targetName;
        matchCards[3]=dist1Name;
        matchCards[4]=dist1Name;
        matchCards[5]=dist1Name;
        matchCards[6]=dist2Name;
        matchCards[7]=dist2Name;
        matchCards[8]=dist2Name;
      break;
  }
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	if (play_status==1) 
    {
        ...
        for  (i = 0; i<no_cards; i++)
        {
            ...
            touchXOffset = imgMatch[i].center.x - [touch locationInView:touch.view].x;
            touchYOffset = imgMatch[i].center.y - touchY;
...
- (void) playActivityHelp
{
    ...
    {
        [self stopSound];
        activityHelpSoundName = @"activity_instruction_picture";
...
- (void) showHelpOverview
{
    ...
    switch (helpNo){
        case 0:
        {
            helpText1 = @"Match IT activities help survivors of stroke and brain injury to develop key\nskills while they interact with friends and family.\n\nThere are several versions of Match IT, in Match IT Food:\n   •	The aim is to drag the smaller picture cards onto the matching large\n        picture cards in the shortest possible time. \n  •	The picture cards are neither semantically nor phonologically related \n  •	One picture card is always an item of food, the other picture cards are\n        everyday objects \n\nSkills - this activity may help to develop: \n  •	Visual processing skills such as scanning and picture card analysis\n  •	Problem solving skills \n  •	Executive functions\n  •	Attention skills\n  •	Language skills";
...
- (void) showHelpInstructions
{
    ...
    switch (helpNo){
        case 0:
        {
            helpText1 = @"1. You will see two large picture cards at the top of the screen.\n\n2. You will also see a range of smaller picture cards on the rest of the screen.\n\n3. The aim is to drag the smaller picture cards onto the matching large picture\n    cards in the shortest possible time.\n\n4. When you have made a match the smaller picture card will disappear. \n\n5. Unmatched picture cards will return to their original position. \n\n6. When you have made all the possible matches, another set of picture cards\n    will appear.\n\n7. A total of 12 matching picture cards will appear during each activity. \n\n";
            helpText.text = helpText1;
...
- (void) showHelpLevels
{
    ...
    helpText1 = @"LEVEL 1\nYou will see 4 smaller picture cards; all of these match the large picture cards at the top of the screen.  You can complete 3 rounds of 4 matches.\n\nLEVEL 2\nYou will see 6 smaller picture cards, 4 of these match the large picture cards and there are 2 distractors.  You can complete 3 rounds of 4 matches.\n\nLEVEL 3\nYou will see 9 picture cards, 6 of these match the large picture cards and there are 3 distractors.  You can complete 2 rounds of 6 matches.\n\nLEVELS 4-6\nThese levels map mirror levels 1-3 but they include slow movement.\n\nLEVELS 7-9\nThese levels mirror levels 1-3 but they include fast movement.";
    helpText.text = helpText1;
...
- (void) showHelpGlossary
{
    ...
    helpText1 = @"'SEMANTIC'\nThe meaning of a word.\n\n'SEMANTICALLY RELATED PICTURE CARDS'\nPicture cards that come from the same semantic category. E.g. two food items such as an 'apple' and an 'egg'.\n\n'PHONOLOGICAL'\nThe sound of a word.\n\n'PHONOLOGICALLY RELATED PCTURE CARDS'\nPicture cards that sound the same. E.g. two items starting with the same sound such as ‘car’ and ‘cake’.\n\n'DISTRACTORS' \nPicture cards that do not match the target picture cards.  These picture cards are introduced to increase the level of difficulty by creating a distraction.";
    helpText.text = helpText1;
